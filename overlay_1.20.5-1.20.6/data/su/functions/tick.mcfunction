...
execute unless data storage su:settings slut as @e[limit=1,sort=nearest,type=minecraft:armor_stand,tag=slutchest] at @s run function su:f/sc/sluttick
execute unless data storage su:settings slut as @e[type=item,nbt={Age:5998s}] at @s unless predicate su:scblacklist as @e[limit=1,sort=nearest,type=minecraft:armor_stand,tag=slutchest] run function su:f/sc/slutitem
execute unless data storage su:settings slut as @e[type=item] unless entity @s[nbt={Health:5s}] at @s unless predicate su:scblacklist as @e[limit=1,sort=nearest,type=minecraft:armor_stand,tag=slutchest] run function su:f/sc/slutitem
execute unless data storage su:settings slut as @e[type=item,tag=encumbered,nbt={Age:1200s}] at @s unless predicate su:scblacklist as @e[limit=1,sort=nearest,type=minecraft:armor_stand,tag=slutchest] run function su:f/sc/slutitem
execute unless data storage su:settings slut in minecraft:the_end as @e[type=item,predicate=su:outofworld] unless predicate su:endblacklist unless predicate su:scblacklist in minecraft:overworld as @e[limit=1,sort=nearest,type=minecraft:armor_stand,tag=slutchest] run function su:f/sc/slutitem
