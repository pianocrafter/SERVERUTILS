...
scoreboard objectives add su.bowtest minecraft.used:minecraft.bow 
scoreboard objectives add su.crossbowtest minecraft.used:minecraft.crossbow
scoreboard objectives add su.multishot dummy
