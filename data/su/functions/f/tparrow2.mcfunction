...
execute if data entity @s Potion at @s run summon item ~ ~ ~ {PickupDelay:0,Item:{id:"minecraft:tipped_arrow",count:1}}
execute if data entity @s Potion run data modify entity @e[type=item,limit=1,sort=nearest] Item.components set from entity @s item.components
