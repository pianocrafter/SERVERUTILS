...
execute as @e[type=minecraft:area_effect_cloud,tag=playerKillTest,distance=..128] at @s as @e[type=experience_orb,tag=PlayerItem,distance=..8] at @s run function su:f/tpitem
...
#execute if entity @s[nbt={SelectedItem:{tag:{Enchantments:[{id:"minecraft:infinity"}]}}}] run scoreboard players set @s infinityBan 200
#execute if entity @s[nbt={Inventory:[{Slot:-106b,tag:{Enchantments:[{id:"minecraft:infinity"}]}}]}] run scoreboard players set @s infinityBan 200
#execute if entity @s[nbt={SelectedItem:{tag:{Enchantments:[{id:"minecraft:multishot"}]}}}] run scoreboard players set @s su.multishot 200
#execute if entity @s[nbt={Inventory:[{Slot:-106b,tag:{Enchantments:[{id:"minecraft:multishot"}]}}]}] run scoreboard players set @s su.multishot 200
tag @s[scores={su.bowtest=1..}] add su.shotarrow
tag @s[scores={su.crossbowtest=1..}] add su.shotarrow
execute unless entity @s[gamemode=creative] as @e[type=#minecraft:arrows,tag=playerarrow,nbt={life:20s,pickup:1b},distance=..128] at @s run function su:f/tparrow
execute unless entity @s[gamemode=creative] as @e[type=#minecraft:arrows,tag=playerarrow,nbt={life:21s,pickup:2b},distance=..128] at @s run kill @s
...
#scoreboard players remove @s[scores={su.multishot=1..}] su.multishot 1
