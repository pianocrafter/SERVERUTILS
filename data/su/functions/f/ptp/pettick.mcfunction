...
execute at @e[type=#su:pets,nbt={Sitting:0b},distance=64..] if data entity @e[sort=nearest,type=#su:pets,limit=1] Owner unless data entity @s Leash run function su:f/ptp/pettest
