...
execute as @s[scores={magnet=1},tag=!magnetenable] run playsound minecraft:entity.enderman.teleport master @s ~ ~ ~
...
execute as @s[scores={magnet=0},tag=magnetenable] run playsound minecraft:entity.enderman.teleport master @s ~ ~ ~ 
...
execute as @s[scores={surface=1..}] if dimension minecraft:overworld at @s run playsound minecraft:entity.enderman.teleport master @s ~ ~ ~
