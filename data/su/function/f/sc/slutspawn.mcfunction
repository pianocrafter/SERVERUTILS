...
execute positioned 0 ~ 0 at @n[type=minecraft:armor_stand,tag=slutchest] run setblock ~ ~ ~ chest[facing=south,type=right]{CustomName:'{"bold":true,"color":"dark_purple","italic":false,"text":"Slut Chest"}'}
execute positioned 0 ~ 0 at @n[type=minecraft:armor_stand,tag=slutchest] run setblock ~1 ~ ~ chest[facing=south,type=left]{CustomName:'{"bold":true,"color":"dark_purple","italic":false,"text":"Slut Chest"}'}
