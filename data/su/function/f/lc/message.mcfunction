...
execute unless data storage su:structures s.pvillage run function su:f/lc/messageid {s:"Village",color:"green",id:"11"}
execute if data storage su:structures s.pvillage run function su:f/lc/messageid {s:"Village",color:"red",id:"11"}
execute if dimension minecraft:overworld run function su:f/lc/messageadd with storage su:structures message
...
execute unless data storage su:structures s.whut run function su:f/lc/messageid {s:"Witch Hut",color:"green",id:"17"}
execute if data storage su:structures s.whut run function su:f/lc/messageid {s:"Witch Hut",color:"red",id:"17"}
execute if dimension minecraft:overworld run function su:f/lc/messageadd with storage su:structures message

execute unless data storage su:structures s.trial run function su:f/lc/messageid {s:"Trial Chambers",color:"green",id:"18"}
execute if data storage su:structures s.trial run function su:f/lc/messageid {s:"Trial Chambers",color:"red",id:"18"}
execute if dimension minecraft:overworld run function su:f/lc/messageadd with storage su:structures message
