...
execute if entity @s[scores={glowmobs=14}] run function su:f/gm/ravager
execute if entity @s[scores={glowmobs=15}] run function su:f/gm/sheep
execute if entity @s[scores={glowmobs=16}] run function su:f/gm/shulker
execute if entity @s[scores={glowmobs=17}] run function su:f/gm/squid
execute if entity @s[scores={glowmobs=18}] run function su:f/gm/squidg
execute if entity @s[scores={glowmobs=19}] run function su:f/gm/villager
execute if entity @s[scores={glowmobs=20}] run function su:f/gm/witch
...
execute if entity @s[scores={glowmobs=99}] run function su:f/gm/3disableall
